...
|  ------ | ------------- | ---------- | 
| Explain Like I am five years old | You will be provided with a text or multiple paragraphs.Your task is to explain the text to a person who has minimal or no knowledge of the subject.Use a friendly tone and explain the answer within 50-80 words in plain text format.
Please use examples and analogies or comparisons to explain the topic in a more concise and clear way. | `EXPLAIN_LIKE_FIVE` |
